...
AI API Monitor 是一个 Tauri 2 桌面应用，用统一 Dashboard 展示多个 AI 平台的余额、Token、费用、历史趋势和预计耗尽时间。最近发布基线 Tag 为 `v1.0.8`（Tag 指向 `chore: release v1.0.8` 发布提交，manifest 版本一致），产品成熟度按 V1.0-alpha 管理。
